...
# Base-palette slots MUST NOT overlap with primary feature slots in
# ``_FEATURE_TILES`` — a featureless cell rendering as ``farms`` /
# ``lake`` / ``ruins`` advertises a feature the gameplay code never
# generated. See ``test_base_palettes_do_not_alias_feature_slots``.
BIOME_BASE_SLOTS: dict[str, list[tuple[int, int]]] = {
    "greenlands": [
        (42, 20), (4, 18), (43, 15), (45, 12), (2, 8),
        (41, 5), (50, 4), (20, 3),
    ],
    "forest": [

...
export function unionToOp(
  type: Op,
  accessor: (obj:BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp) => BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp|null
): BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp|null {
  switch(Op[type]) {
...
export function unionListToOp(
  type: Op, 
  accessor: (index: number, obj:BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp) => BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp|null, 
  index: number
): BushFeatureOp|DecoratorOp|EnclosureOp|FloorDetailOp|FloorGridOp|FountainFeatureOp|GenericProceduralOp|HatchOp|RoofOp|ShadowOp|StairsOp|TerrainDetailOp|TerrainTintOp|ThematicDetailOp|TreeFeatureOp|WallsAndFloorsOp|WellFeatureOp|null {
  switch(Op[type]) {
    case 'NONE': return null; 

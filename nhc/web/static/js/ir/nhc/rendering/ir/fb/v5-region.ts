...
export class V5Region {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):V5Region {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsV5Region(bb:flatbuffers.ByteBuffer, obj?:V5Region):V5Region {
  return (obj || new V5Region()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsV5Region(bb:flatbuffers.ByteBuffer, obj?:V5Region):V5Region {
...
static startV5Region(builder:flatbuffers.Builder) {
...
static endV5Region(builder:flatbuffers.Builder):flatbuffers.Offset {

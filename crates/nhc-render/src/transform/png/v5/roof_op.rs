//! V5RoofOp consumer — projection-geometry shingled roof.
//!
//! Phase 3.1 follow-on of `plans/nhc_pure_ir_v5_migration_plan.md`.
//! Bridges the v5 ``V5RoofOp`` to the polygon-driven inner painter
//! `super::super::roof::draw_roof_polygon` lifted from the v4 RoofOp
...
//!    region's outline.
//! 3. Pull tint + seed from the V5RoofOp; build a clip path from
...
//!
//! The v5 Material model (V5RoofStyle / tone) is currently unused
...
use crate::ir::{V5Region, V5RoofOp};
...
pub fn draw<'a>(
    ...
    let region = match super::find_v5_region(regions, region_ref) {
        Some(r) => r,
        None => return false,
    };
    ...
    super::super::roof::draw_roof_polygon(
        painter,
        &polygon,
        shape_tag,
        tint,
...
mod tests {
    ...
    use crate::ir::{
        ...
        V5Region as FbV5Region, V5RegionArgs, V5RoofOp as FbV5RoofOp,
        V5RoofOpArgs, V5RoofStyle, Vec2 as FbVec2,
    };

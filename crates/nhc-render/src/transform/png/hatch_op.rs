//! HatchOp consumer — hatched outer band.
//!
...
use crate::ir::{HatchKind, HatchOp, Region};
...
mod tests {
    ...
    use crate::ir::{
        ...
        HatchKind, TileCoord, HatchOp as FbHatchOp, HatchOpArgs,
